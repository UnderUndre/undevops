...
export const { DATABASE_URL, POSTGRES_PASSWORD_FILE, POSTGRES_USER = "undevops", POSTGRES_DB = "undevops", POSTGRES_HOST = "undevops-postgres", POSTGRES_PORT = "5432", } = process.env;
