...
export const deployments = pgTable("deployment", {
    ...
    pid: text("pid"),
    applicationId: text("applicationId").references(() => applications.applicationId, { onDelete: "cascade" }),
    ...
    previewDeploymentId: text("previewDeploymentId").references(() => previewDeployments.previewDeploymentId, { onDelete: "cascade" }),
    ...
    scheduleId: text("scheduleId").references(() => schedules.scheduleId, { onDelete: "cascade" }),
    backupId: text("backupId").references(() => backups.backupId, {
        onDelete: "cascade",
    }),
    rollbackId: text("rollbackId").references(() => rollbacks.rollbackId, { onDelete: "cascade" }),
    volumeBackupId: text("volumeBackupId").references(() => volumeBackups.volumeBackupId, { onDelete: "cascade" }),
