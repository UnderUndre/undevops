...
export declare const postgres: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "postgres";
    schema: undefined;
    columns: {
...
export declare const postgresRelations: import("drizzle-orm").Relations<"postgres", {
...
export declare const apiCreatePostgres: z.ZodObject<{
    name: z.ZodString;
...
export declare const apiFindOnePostgres: z.ZodObject<{
    postgresId: z.ZodString;
}, z.core.$strip>;
export declare const apiChangePostgresStatus: z.ZodObject<{
    ...
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
export declare const apiSaveEnvironmentVariablesPostgres: z.ZodObject<{
    env: z.ZodNonOptional<z.ZodOptional<z.ZodNullable<z.ZodOptional<z.ZodString>>>>;
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
export declare const apiSaveExternalPortPostgres: z.ZodObject<{
    externalPort: z.ZodNonOptional<z.ZodOptional<z.ZodNullable<z.ZodNumber>>>;
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
export declare const apiDeployPostgres: z.ZodObject<{
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
export declare const apiResetPostgres: z.ZodObject<{
    appName: z.ZodNonOptional<z.ZodOptional<z.ZodOptional<z.ZodString>>>;
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
export declare const apiUpdatePostgres: z.ZodObject<{
...
export declare const apiRebuildPostgres: z.ZodObject<{
    postgresId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
