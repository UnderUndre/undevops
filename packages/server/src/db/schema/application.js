import { VALID_BRANCH_REGEX } from "@undevops/server/utils/git-branch-validation";
import { relations } from "drizzle-orm";
import { bigint, boolean, integer, json, pgEnum, pgTable, text, } from "drizzle-orm/pg-core";
...
import { applicationStatus, certificateType, EndpointSpecSwarmSchema, HealthCheckSwarmSchema, LabelsSwarmSchema, NetworkSwarmSchema, PlacementSwarmSchema, RestartPolicySwarmSchema, ServiceModeSwarmSchema, triggerType, UlimitsSwarmSchema, UpdateConfigSwarmSchema, } from "./shared";
...
export const applications = pgTable("application", {
    ...
    customGitSSHKeyId: text("customGitSSHKeyId").references(() => sshKeys.sshKeyId, {
        onDelete: "set null",
    }),
    ...
    rollbackRegistryId: text("rollbackRegistryId").references(() => registry.registryId, {
        onDelete: "set null",
    }),
    ...
    buildRegistryId: text("buildRegistryId").references(() => registry.registryId, {
        onDelete: "set null",
    }),
});
