...
export declare const apiCreateMongo: z.ZodObject<{
    ...
    replicaSets: z.ZodOptional<z.ZodNullable<z.ZodDefault<z.ZodBoolean>>>;
}, z.core.$strip>;
...
export declare const apiChangeMongoStatus: z.ZodObject<{
    ...
    mongoId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
...
export declare const apiUpdateMongo: z.ZodObject<{
