import { generatePassword } from "@undevops/server/templates";
...
export const APP_NAME_MESSAGE = "App name can only contain letters, numbers, dots, underscores and hyphens";
/** Database password: blocks shell-dangerous characters like $ ! ' " \ / and spaces. */
export const DATABASE_PASSWORD_REGEX = /^[a-zA-Z0-9@#%^&*()_+\-=[\]{}|;:,.<>?~`]*$/;
export const DATABASE_PASSWORD_MESSAGE = "Password contains invalid characters. Please avoid: $ ! ' \" \\ / and space characters for database compatibility";
