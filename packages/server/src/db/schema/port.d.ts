...
export declare const apiCreatePort: z.ZodObject<{
    ...
    protocol: z.ZodNonOptional<z.ZodDefault<z.ZodEnum<{
        tcp: "tcp";
        udp: "udp";
    }>>>;
    publishedPort: z.ZodNonOptional<z.ZodNumber>;
    publishMode: z.ZodNonOptional<z.ZodOptional<z.ZodDefault<z.ZodEnum<{
        host: "host";
        ingress: "ingress";
    }>>>>;
    targetPort: z.ZodNonOptional<z.ZodNumber>;
}, z.core.$strip>;
...
export declare const apiUpdatePort: z.ZodObject<{
    ...
    portId: z.ZodNonOptional<z.ZodOptional<z.ZodString>>;
    publishedPort: z.ZodNonOptional<z.ZodNumber>;
    publishMode: z.ZodNonOptional<z.ZodOptional<z.ZodDefault<z.ZodEnum<{
        host: "host";
        ingress: "ingress";
