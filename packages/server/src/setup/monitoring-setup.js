...
export const setupMonitoring = async (serverId) => {
    ...
    try {
        await execAsyncRemote(serverId, "mkdir -p /etc/dokploy/monitoring && touch /etc/dokploy/monitoring/monitoring.db");
        if (serverId) {
...
export const setupWebMonitoring = async () => {
    ...
    try {
        await execAsync("mkdir -p /etc/dokploy/monitoring && touch /etc/dokploy/monitoring/monitoring.db");
