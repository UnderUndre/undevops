...
import { member, organization, server, } from "@undevops/server/db/schema";
...
export const findServersByUserId = async (userId) => {
...
export const haveActiveServices = async (serverId) => {
    ...
    const total = currentServer?.applications?.length +
...
export const updateServerById = async (serverId, serverData) => {
