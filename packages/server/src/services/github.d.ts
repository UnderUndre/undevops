import { type apiCreateGithub, github } from "@undevops/server/db/schema";
import type { z } from "zod";
export type Github = typeof github.$inferSelect;
export declare const createGithub: (input: z.infer<typeof apiCreateGithub>, organizationId: string, userId: string) => Promise<{
