...
import { findBitbucketById, } from "@undevops/server/services/bitbucket";
...
export const cloneBitbucketRepository = async ({ type = "application", ...entity }) => {
    let command = "set -e;";
    const { appName, bitbucketRepository, bitbucketOwner, bitbucketBranch, bitbucketId, enableSubmodules, serverId, outputPathOverride, } = entity;
