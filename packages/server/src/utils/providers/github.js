...
import { findGithubById } from "@undevops/server/services/github";
...
export const cloneGithubRepository = async ({ type = "application", ...entity }) => {
    ...
    const { appName, repository, owner, branch, githubId, enableSubmodules, serverId, outputPathOverride, } = entity;
