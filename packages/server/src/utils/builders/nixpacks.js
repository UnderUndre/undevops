...
import { getStaticCommand } from "@undevops/server/utils/builders/static";
import { nanoid } from "nanoid";
import { prepareEnvironmentVariablesForShell } from "../docker/utils";
import { getBuildAppDirectory } from "../filesystem/directory";
export const getNixpacksCommand = (application) => {
    ...
    if (publishDirectory) {
        ...
        const isDirectory = publishDirectory.endsWith("/") || !path.extname(publishDirectory);
        bashCommand += `
