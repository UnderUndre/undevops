...
import { parseEnvironmentKeyValuePair, prepareEnvironmentVariables, prepareEnvironmentVariablesForShell, } from "../docker/utils";
import { getBuildAppDirectory } from "../filesystem/directory";
const calculateSecretsHash = (envVariables) => {
...
export const getRailpackCommand = (application) => {
    ...
    const rawEnvVariables = prepareEnvironmentVariables(env, application.environment.project.env, application.environment.env);
    const exportEnvs = [];
