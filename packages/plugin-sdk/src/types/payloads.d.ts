...
export interface PluginApiClient {
    ...
    getProjectLogs(projectId: string, opts?: {
        lines?: number;
        level?: string;
    }): Promise<LogLine[]>;
}
...
export type HookName = "pre-deploy" | "post-deploy" | "deploy-failed" | "server-added" | "server-removed" | "project-created" | "project-deleted";
...
export declare const HOOK_TO_METHOD: Record<HookName, keyof UndevopsPlugin>;
