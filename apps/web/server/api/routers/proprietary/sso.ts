import { normalizeTrustedOrigin } from "@undevops/server";
import { IS_CLOUD } from "@undevops/server/constants";
import { db } from "@undevops/server/db";
import { member, ssoProvider, user } from "@undevops/server/db/schema";
import { ssoProviderBodySchema } from "@undevops/server/db/schema/sso";
import {
	getOrganizationOwnerId,
	requestToHeaders,
} from "@undevops/server/index";
import { auth } from "@undevops/server/lib/auth";
