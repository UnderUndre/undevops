import type { ApplicationNested } from "@undevops/server/utils/builders";
import { mechanizeDockerContainer } from "@undevops/server/utils/builders";
...
vi.mock("@undevops/server/utils/servers/remote-docker", () => ({
