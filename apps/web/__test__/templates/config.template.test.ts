import type { Schema } from "@undevops/server/templates";
import type { CompleteTemplate } from "@undevops/server/templates/processors";
import { processTemplate } from "@undevops/server/templates/processors";
